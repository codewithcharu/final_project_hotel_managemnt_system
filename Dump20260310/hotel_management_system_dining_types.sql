...
DROP TABLE IF EXISTS `dining_types`;
...
CREATE TABLE `dining_types` (
  ...
  `max_concurrent_reservations` int NOT NULL DEFAULT '10',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_p17sddlmtft8wwli6eg2dxarf` (`name`)
...
-- Dump completed on 2026-03-10 18:53:49
